...
@Slf4j
@Service
public class FileServiceImpl extends AbstractCrudService<FileMark, BigInteger> implements FileService {
    ...
    public FileServiceImpl(FileMarkRepository repository,
    ...
    public FileMark uploadFiles(MultipartFile file, FileTypeEnum fileTypeEnum) {
        ...
        return fileService.uploadFiles(files,fileTypeEnum).get(0);
    }
